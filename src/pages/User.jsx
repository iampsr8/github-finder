...
function User() {
  ...
  return (
      <>
          <div className="w-full mx-auto lg:w-10/12 text-slate-100">
              <div className="mb-4 ">
                  ...
                  <div className="custom-card-image mb-6 md:mb-0">
                      <div className="rounded-lg shadow-xl card image-full">
                          ...
                          <div className="card-body justify-end ">
                              <h2 className="card-title mb-0 text-slate-50">
                                  {name}
                              </h2>
                              <p className='flex-grow-0 text-slate-50'>{ login}</p>
                          </div>
                      </div>
                  </div>
              ...
              <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                  <div className="stat text-slate-100">
